...
export const DISTANCE_SCHEMA = z.object({
  ...
  multiplier: COMPOSITE_NUMBER_SCHEMA.default({}).describe(
    "The SPECIAL multiplier of the range distance"
  ),
...
export const RANGE_SCHEMA = z.object({
  ...
  modifier: COMPOSITE_NUMBER_SCHEMA.default({}).describe(
    "The skill check modifier associated with this range"
  ),
...
export const RANGES_SCHEMA = z.object({
  ...
  medium: RANGE_SCHEMA.default({}).describe("The medium range of the weapon"),

  /** The long range of the weapon */
  long: RANGE_SCHEMA.default({}).describe("The long range of the weapon")
});
