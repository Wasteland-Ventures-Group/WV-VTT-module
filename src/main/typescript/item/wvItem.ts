...
export class WeaponSystem extends TypeDataModel<typeof weapon_data_model, WvItem> { }
...
export class MagicSystem extends TypeDataModel<typeof race_data_model, WvItem> { }
export class ApparelSystem extends TypeDataModel<typeof race_data_model, WvItem> { }
export class EffectSystem extends TypeDataModel<typeof race_data_model, WvItem> { }
...
export default class WvItem extends Item<ProtoItemType> {
    ...
    override prepareBaseData(): void {
        if (this.type === "misc") {
            this.system = new MiscDataPropertiesData(this.system, this);
        }
    }
