...
export const TAG_SELECTOR_JSON_SCHEMA: JSONSchemaType<TagSelectorSource> = {
...
export const TYPE_SELECTOR_JSON_SCHEMA: JSONSchemaType<TypeSelectorSource> = {
...
export const USES_SKILL_SELECTOR_JSON_SCHEMA: JSONSchemaType<UsesSkillSelectorSource> =
  {
...
export const OR_SELECTOR_JSON_SCHEMA: JSONSchemaType<OrSelectorSource> = {
    ...
    or: {
      ...
      items: {
        oneOf: [
          ...
          TAG_SELECTOR_JSON_SCHEMA,
          TYPE_SELECTOR_JSON_SCHEMA,
          USES_SKILL_SELECTOR_JSON_SCHEMA
        ]
      }
    }
  },
...
export const DOCUMENT_SELECTOR_JSON_SCHEMA = {
  description: "A schema for document selector sources",
  oneOf: [
    KEYWORD_SELECTOR_WORD_JSON_SCHEMA,
    OR_SELECTOR_JSON_SCHEMA,
    TAG_SELECTOR_JSON_SCHEMA,
    TYPE_SELECTOR_JSON_SCHEMA,
    USES_SKILL_SELECTOR_JSON_SCHEMA
  ]
